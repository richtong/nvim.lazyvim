-- As for 8 Feb 2025 no longer can you add extras here
-- You should use LazyVim Extras to add instead of doing this here
--
-- https://github.com/LazyVim/LazyVim/issues/5555
